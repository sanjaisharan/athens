...
export default function Jersy1()
{
  ...
  return (
    ...
    <Card sx={{ width:"1500px"}}>
      ...
      <CardContent>
        <Typography variant="body2" color="black">
        BKDT Marketing Bowling Toy Set with 10 Bottles and 2 Balls Game for Game for Kids - Multicolor
        </Typography>
      </CardContent>
      <div style={{fontFamily:"fantasy",fontSize:"20px"}}>
...
BKDT Marketing Bowling
    ...
    <Card sx={{ width:"1500px"}}>
      ...
      <CardContent>
        <Typography variant="body2" color="black">
        BKDT Marketing Bowling Toy Set with 10 Bottles and  Game for Kids - Multicolor
        </Typography>
      </CardContent>
      <div style={{fontFamily:"fantasy",fontSize:"20px"}}>
      <center>PRICE: $25 &nbsp;&nbsp;&nbsp;&nbsp;<strike>$15</strike></center> 
